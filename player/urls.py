...
from .views import home,new_invitation,accept_invitations,SignUpView
...
urlpatterns=[
    ...
    url(r'logout$',LogoutView.as_view(template_name="player/logout_form.html"),name='player_logout'),
